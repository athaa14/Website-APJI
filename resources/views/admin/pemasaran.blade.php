                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Terima -->
                                <a href="#" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#acceptModal" data-id="{{ $data->id_pemasaran }}">
                                    <i class="bx bx-check-circle"></i>
                                </a>

                                <!-- Tombol Tolak -->
                                <a href="#" class="btn btn-danger btn-sm" onclick="handleReject({{ $data->id_pemasaran }})">
