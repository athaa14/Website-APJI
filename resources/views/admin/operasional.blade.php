                    ...
                    <tbody>
                        @foreach ($dataOperasional as $data)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Terima -->
                                    <a href="#" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#acceptModal" data-id="{{ $data->id_operasional }}">
                                        <i class="bx bx-check-circle"></i>
                                    </a>

                                    <!-- Tombol Tolak -->
                                    <a href="#" class="btn btn-danger btn-sm" onclick="handleReject({{ $data->id_operasional }})">
